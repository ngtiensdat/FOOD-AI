...
### [ ] BƯỚC 1: Cập nhật Schema Cơ sở dữ liệu (Prisma Backend)
...
### [ ] BƯỚC 2: Cập nhật DTO & Service tại Backend
...
### [ ] BƯỚC 3: Thiết kế Giao diện Chi tiết Dinh dưỡng (Frontend Modal)
...
### [ ] BƯỚC 1: Tối ưu hóa Sidebar trên màn hình di động (< 768px)
...
### [ ] BƯỚC 2: Tối ưu co giãn cho Modals và Bảng Biểu
