/**
 * Mục đích file này để làm gì: Đây là trang Profile của Nhà hàng (Restaurant) phía Client. Đóng vai trò Orchestrator quản lý toàn bộ các tính năng như hiển thị Header, Tab Menu (với Sidebar Category và Grid Món ăn), Tab Info, và các Modal theo dõi.
 ...
 * Các biến, hàm đặc biệt trong file: Hook `useRestaurantProfile` điều phối chính. Component `RestaurantClientPage` bọc ngoài cùng.
 */
'use client';
