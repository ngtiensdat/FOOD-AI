...
export default function RestaurantDashboard() {
  ...
  const voucherSubItems = [
    ...
    },
    {
      ...
      onClick: () => {
        setActiveTab('vouchers');
        setVoucherSubTab('VERIFY_VOUCHER');
      }
    },
    {
    ...
    <div className="admin-layout flex flex-col min-h-screen bg-gray-50 dark:bg-slate-950">
      ...
      <div className="flex pt-20 min-h-[calc(100vh-5rem)] w-full">
        ...
        <Sidebar
          ...
          footer={
            <div className="space-y-2 w-full">
              ...
              <Button
                onClick={actions.handleOpenAdd}
                className={`w-full bg-primary hover:bg-primary-light text-white font-bold rounded-xl flex items-center justify-center transition-all shadow-md shadow-primary/20 cursor-pointer ${isCollapsed ? 'p-3 aspect-square' : 'py-3 px-4 gap-2 hover:scale-[1.02] active:scale-95'
                  }`}
              ...
              <Button
                onClick={() => setIsUploadModalOpen(true)}
                variant="outline"
                className={`w-full border-gray-200 dark:border-slate-800 text-gray-700 dark:text-slate-300 font-bold rounded-xl flex items-center justify-center transition-all cursor-pointer ${isCollapsed ? 'p-3 aspect-square' : 'py-3 px-4 gap-2 hover:bg-gray-50 dark:hover:bg-slate-950'
                  }`}
        ...
        >
          ...
          <SidebarItem
            icon={Tag}
            label={LABELS.RESTAURANT.SIDEBAR.PROMOTION_MANAGEMENT}
            ...
            {activeTab === 'vouchers' && restaurant && (
              <div className="space-y-6">
                ...
                <VoucherManager
                  ...
                  activeSubTab={voucherSubTab}
                  onTabChange={setVoucherSubTab}
                />
              </div>
            )}
