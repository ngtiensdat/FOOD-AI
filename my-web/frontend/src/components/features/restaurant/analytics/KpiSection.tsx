...
export const KpiSection = React.memo(({ totalViews, totalAiSuggestions, conversionRate }: KpiSectionProps) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      {/* Views Card */}
      <div id="kpi-views" className="card-premium p-6 flex items-center gap-4 bg-gradient-to-br from-blue-500/10 to-transparent border-blue-500/20">
      ...
      <div id="kpi-ai" className="card-premium p-6 flex items-center gap-4 bg-gradient-to-br from-amber-500/10 to-transparent border-amber-500/20">
      ...
      <div id="kpi-conversion" className="card-premium p-6 flex items-center gap-4 bg-gradient-to-br from-emerald-500/10 to-transparent border-emerald-500/20">
